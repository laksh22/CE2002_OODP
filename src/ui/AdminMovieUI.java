...
import movielistingdao.HolidaysManager;
...
public class AdminMovieUI {
        ...
        while (choice != 0) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    HolidaysManager.addHolidayDates(date);
                    break;
                case 3:
                    topBySales();
                    break;
        ...
        while (ch != 0) {
            ...
            switch (ch) {
                case 1:
                    ...
                    PriceManager.rewrite(Price_Path, table);
                    break;
                case 2:
                    System.out.println("Enter New Price:");
    ...
    /**
     * UI method to prompt user to enter a new movie
     */
    private void enterNewMovie() {
        ...
        int censorClassificationIndex;
        while (true) {
            try {
                censorClassificationIndex = scanner.nextInt();
                scanner.nextLine();
                break;
            } catch (InputMismatchException e) {
                System.out.println("Enter a number!\n");
    ...
    private void changeMovieStatus() {
        ...
        // Update all the current movie listings to reflect the change in status
        AdminMovieListingManager adminMovieListingManager = new AdminMovieListingManager("ADMIN");
        for (MovieListing movieListing : adminMovieListingManager.getAllMovieListings()) {
            if (movieListing.getMovie().getTitle().equals(oldMovie.getTitle())) {
                movieListing.getMovie().setStatus(status);
            }
        }
        adminMovieListingManager.saveDatabase();
    ...
    private void listMovie(Movie movie) {
        ...
        System.out.println("Sales figure: " + movie.getSales());
    }
    ...
    private void updateMovieDetails() {
        ...
        movie.setCensorClassification(censorClassificationIndex);
        movie.setCasts(casts);
        movie.setTypeOfMovie(genre);
